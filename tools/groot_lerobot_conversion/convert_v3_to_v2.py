...
#
# ---------------------------------------------------------------------------
# VENDORED, UNMODIFIED from NVIDIA/Isaac-GR00T:
#   scripts/lerobot_conversion/convert_v3_to_v2.py
# Upstream: https://github.com/NVIDIA/Isaac-GR00T
# Do not edit this file. GR00T-specific glue (local-dir invocation and
# modality.json preservation) lives in groot_convert.py alongside it, so this
# vendored copy can be refreshed from upstream without merge conflicts.
# ---------------------------------------------------------------------------
